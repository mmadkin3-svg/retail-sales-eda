# retail-sales-eda
Exploratory Data Analysis of retail transactions using SQL (BigQuery)  and Tableau Public
# Retail Sales EDA

**Tools:** BigQuery SQL · Tableau Public
**Dataset:** Mohammad Talib · Kaggle Retail Sales Dataset (1,000 transactions)
